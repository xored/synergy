...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Data Source Entry</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class DataSourceEntryImpl extends EObjectImpl implements DataSourceEntry {
	...
	public NotificationChain basicSetContent(EObject newContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CommonPackage.DATA_SOURCE_ENTRY__CONTENT, oldContent, newContent);
	...
	public void setContent(EObject newContent) {
		if (newContent != content) {
			...
			if (content != null)
				msgs = ((InternalEObject)content).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CommonPackage.DATA_SOURCE_ENTRY__CONTENT, null, msgs);
			if (newContent != null)
				msgs = ((InternalEObject)newContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CommonPackage.DATA_SOURCE_ENTRY__CONTENT, null, msgs);
			msgs = basicSetContent(newContent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CommonPackage.DATA_SOURCE_ENTRY__CONTENT, newContent, newContent));
	}
