...
public class CommonAdapterFactory extends AdapterFactoryImpl {
	...
	protected CommonSwitch<Adapter> modelSwitch =
		new CommonSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDataSourceEntry(DataSourceEntry object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.xored.x5.common.DataSourceEntry <em>Data Source Entry</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
