...
public class WorkspaceAdapterFactory extends AdapterFactoryImpl {
	...
	protected WorkspaceSwitch<Adapter> modelSwitch =
		new WorkspaceSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDiskPartition(DiskPartition object) {
				return createDiskPartitionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.xored.sherlock.eclipse.workspace.Workspace <em>Workspace</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.xored.sherlock.eclipse.workspace.DiskPartition <em>Disk Partition</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
