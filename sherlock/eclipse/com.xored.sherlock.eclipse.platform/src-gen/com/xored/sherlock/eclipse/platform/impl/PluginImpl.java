 ...
 * <ul>
 *   <li>{@link com.xored.sherlock.eclipse.platform.impl.PluginImpl#getId <em>Id</em>}</li>
...
public class PluginImpl extends EObjectImpl implements Plugin {
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.PLUGIN__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.PLUGIN__NAME, oldName, name));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.PLUGIN__VERSION, oldVersion, version));
	}
	...
	public void setProvider(String newProvider) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PlatformPackage.PLUGIN__PROVIDER, oldProvider, provider));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PlatformPackage.PLUGIN__ID:
				return getId();
			case PlatformPackage.PLUGIN__NAME:
				return getName();
			case PlatformPackage.PLUGIN__VERSION:
				return getVersion();
