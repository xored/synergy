...
public class ThreadSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ThreadPackage.THREAD: {
				com.xored.sherlock.thread.Thread thread = (com.xored.sherlock.thread.Thread)theEObject;
	 ...
	 * @generated
	 */
	public T caseThread(com.xored.sherlock.thread.Thread object) {
		return null;
	}
