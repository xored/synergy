...
public class SystemSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SystemPackage.SYSTEM: {
				com.xored.sherlock.system.System system = (com.xored.sherlock.system.System)theEObject;
				T result = caseSystem(system);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SystemPackage.ENTRY: {
	 ...
	 * @generated
	 */
	public T caseSystem(com.xored.sherlock.system.System object) {
		return null;
	}
